...
def mask_outside_regions(original_image, segmented_image, padding):
    ...
    refined_mask = (new_img_gray < 130).astype(np.uint8) * 255  # convert boolean to uint8
    closed = closing(refined_mask,disk(9))
