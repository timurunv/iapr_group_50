...
chocolate_colors = pd.read_csv('/Users/louiscuendet/Documents/EPFL NEURO-X /Image Analysis and Pattern Recognition/iapr_group_50/project/hsv_samples/concatenated.csv')[['H', 'S', 'V']]
